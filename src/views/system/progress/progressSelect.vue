<template>
    ...
    :visible.sync="visible" width="750px">
    <el-row :gutter="20">
...
<script>
import { listProjectInfo} from "@/api/system/projectInfo";
import { listProjectContractByReport} from "@/api/system/projectContract";
export default {
  name: "Stall",
  data() {
    return {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listProjectContractByReport(this.queryParams).then(response => {
