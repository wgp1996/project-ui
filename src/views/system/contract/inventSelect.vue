<template>
    ...
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      <el-form-item label="分项名称" prop="inventoryName">
        <el-input
    ...
    <el-table v-loading="loading" :data="goodsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="分项名称" align="center" prop="inventoryName" />
      <el-table-column label="单位" align="center" prop="inventoryUnit" />
      <el-table-column label="单价" align="center" prop="inventoryPrice" />
...
<script>
import { selectList} from "@/api/system/projectInventory";
export default {
  name: "Stall",
  data() {
    return {
  ...
  methods: {
    ...
    selectGoodsData(row){
        this.$emit('selectInventData',row)
    },
    /** 查询市场摊位信息列表 */
    getList() {
      this.loading = true;
