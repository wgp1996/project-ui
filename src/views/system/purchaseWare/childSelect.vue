<template>
    ...
    :visible.sync="visible2" width="800px">
    <el-row :gutter="20">
     <!--部门数据-->
      <!-- <el-col :span="4" :xs="24">
    ...
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="100px">
      ...
      <el-form-item label="供货商编码" prop="goodsCode">
        <el-input style="width:200px"
    ...
    <el-table v-loading="loading" :data="goodsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="物资名称" align="center" prop="goodsName" />
       <el-table-column label="数量" align="center" prop="surplusNum" />
...
import { listPurchaseOrderChild,getPurchaseOrderChild, addPurchaseOrderChild, updatePurchaseOrderChild, delPurchaseOrderChild, exportPurchaseOrderChild } from "@/api/system/purchaseOrderChild";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.loading = true;
      if(this.queryParams.khCode!=undefined&&this.queryParams.khCode!=""){
