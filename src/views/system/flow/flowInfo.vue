  ...
  <div class="app-container">
      ...
      <el-table-column type="expand">
        <template slot-scope="props">
          ...
          >
            ...
            <el-table-column label="是否角色" align="center" prop="isRoleName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px">
      ...
      <el-tab-pane label="节点明细" name="second">
          <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
              <el-button type="primary" icon="el-icon-plus" size="mini" @click="goodsSelect">新增</el-button>
            </el-col>
          </el-row>
            <el-table
            :data="tableData"
          ...
          >
            ...
            <el-table-column  label="是否角色" width="150">
              <template scope="scope">
                 <el-select v-model="scope.row.isRole" placeholder="请选择是否角色" style="width:100%"
              ...
              <el-table-column label="选择角色" width="200" >
                  <template scope="scope">
                <el-select v-model="scope.row.prId" placeholder="请选择角色" style="width:100%"
                @change="selecter(scope.$index, scope.row)" :disabled="scope.row.one"
               >
                    <el-option
             ...
             <el-table-column  label="选择人员" width="120" >
              <template scope="scope">
                <!-- <el-input
                  ...
                  placeholder=""
                ></el-input> -->
                <el-select v-model="scope.row.prId" placeholder="请选择人员" style="width:100%" 
                 @change="selectStore(scope.$index, scope.row)"  :disabled="scope.row.two"   >
                    <el-option
            ...
            <el-table-column label="是否允许结束" width="120">
              <template scope="scope">
                 <el-select v-model="scope.row.isEnd" placeholder="请选择是否允许结束" style="width:100%"  >
                    <el-option
                      v-for="dict in end"
                      :key="dict.value"
                      :label="dict.label"
...
<script>
import { listFlowInfo, getFlowInfo, delFlowInfo, addFlowInfo, updateFlowInfo, exportFlowInfo,effectFlowInfo,listNode,delFlowNode} from "@/api/system/flowInfo";
...
export default {
  ...
  methods: {
     //追加子表必填样式
    starAdd(obj) {
      if(obj.columnIndex === 0 || obj.columnIndex === 1|| obj.columnIndex === 2|| obj.columnIndex === 4) {
          return 'star';
      }
    },
    /** 查询流程表列表 */
