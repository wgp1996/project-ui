...
import { returnSelectList } from "@/api/system/pickingDelivery";
export default {
  name: "Stall",
  ...
  methods: {
    ...
    getList() {
     this.loading = true;
     this.queryParams.khCode=this.system.khCode
     this.queryParams.projectCode=this.system.projectCode
     this.queryParams.storeCode=this.system.storeCode
      returnSelectList(this.queryParams).then((response) => {
