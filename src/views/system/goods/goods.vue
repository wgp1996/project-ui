<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="goodsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="物资分类" align="center" prop="goodsTypeName" />
      <el-table-column label="品牌" align="center" prop="goodsAddress" />
      <el-table-column label="物资规格" align="center" prop="goodsGg" />
      <el-table-column label="物资单位" align="center" prop="goodsDw" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="物资名称" prop="goodsName">
          <el-input v-model="form.goodsName" placeholder="请输入物资名称" />
        </el-form-item>
        <el-form-item label="物资分类" prop="goodsTypePid">
          <treeselect v-model="form.goodsType" :defaultExpandLevel="3" :options="goodsTypeOptions"   :normalizer="normalizer" placeholder="请选择物资分类父级" />
        </el-form-item>
        <el-form-item label="品牌" prop="goodsAddress">
          <el-input v-model="form.goodsAddress" placeholder="请输入品牌" />
        </el-form-item>
        <el-form-item label="物资规格" prop="goodsGg">
          <el-input v-model="form.goodsGg" placeholder="请输入物资规格" />
        </el-form-item>
        <el-form-item label="物资单位" prop="goodsDw">
           <el-select v-model="form.goodsDw" placeholder="请输入物资单位" style="width:100%">
                <el-option
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除物资建档编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有物资建档数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
