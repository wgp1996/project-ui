<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="120px">
      <el-form-item label="物资分类名称" prop="goodsTypeName">
        <el-input
    ...
    >
      <el-table-column label="物资分类名称" align="center" prop="goodsTypeName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-form-item label="物资分类父级" prop="goodsTypePid">
          <treeselect v-model="form.goodsTypePid" :options="goodsTypeOptions" :normalizer="normalizer" placeholder="请选择物资分类父级" />
        </el-form-item>
        <el-form-item label="物资分类名称" prop="goodsTypeName">
          <el-input v-model="form.goodsTypeName" placeholder="请输入物资分类名称" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$confirm('是否确认删除物资分类编号为"' + row.goodsTypeId + '"的数据项?', "警告", {
